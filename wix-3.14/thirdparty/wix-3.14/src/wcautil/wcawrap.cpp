    ...
    )
{
    ...
    er = ::MsiSetPropertyW(WcaGetInstallHandle(), wzPropertyName, wzPropertyValue);
    ExitOnWin32Error1(er, hr, "failed to set property: %ls", wzPropertyName);
    ...
    )
{
    ...
    cchString = lstrlenW(wzString) + 1; // assume we'll be adding the delim
    cchCustomActionData = 0;
